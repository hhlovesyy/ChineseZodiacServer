...
public class Room {
    ...
    static float[,,] birthConfig = new float[5, 3, 6] {
		//阵营1出生点
		{
            {20.48343f, 4.061752f,2.543324f, 0f,0f,0f},//出生点1
			{-49.9f, 3.8f, -61.4f, 0, 21.4f, 0f},//出生点2
			{-6.2f,  3.8f, -70.7f, 0, 21.9f, 0f},//出生点3
		},
		//阵营2出生点
		{
            {11.42933f,4.061752f,-16.31121f, 0f, 0f, 0f},//出生点1
			{105f, 0f, 216.5f, 0, -156.8f, 0f},//出生点2
			{52.0f,0f, 239.2f, 0, -156.8f, 0f},//出生点3
		},
        //阵营1出生点
		{
            {16.30719f,4.061752f,-15.03763f,0f, 0f, 0f},//出生点1
        ...
        //阵营1出生点
		{
            {-20.82579f,4.061752f,-1.150911f,0f, 0f, 0f},//出生点1
        ...
        //阵营1出生点
		{
            {20.02537f, 4.061752f, -15.22326f, 0f,0f,0f},//出生点1
